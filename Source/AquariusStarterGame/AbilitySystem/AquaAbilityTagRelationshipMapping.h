...
#include "AquaAbilityTagRelationshipMapping.generated.h"

/** Struct that defines the relationship between different ability tags */
USTRUCT()
struct FAquaAbilityTagRelationship
{
	GENERATED_BODY()
...
UCLASS()
class AQUARIUSSTARTERGAME_API UAquaAbilityTagRelationshipMapping : public UDataAsset
{
	GENERATED_BODY()
...
private:
	...
	TArray<FAquaAbilityTagRelationship> AbilityTagRelationships;
