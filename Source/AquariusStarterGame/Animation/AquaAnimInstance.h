...
#include "AquaAnimInstance.generated.h"
 ...
 */
UCLASS(Config = Game)
class AQUARIUSSTARTERGAME_API UAquaAnimInstance : public UAnimInstance
{
	GENERATED_BODY()

public:

	UAquaAnimInstance(const FObjectInitializer& ObjectInitializer);
