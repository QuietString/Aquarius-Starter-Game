...
#include "ItemAnimLayersAnimInstance.generated.h"
 ...
 */
UCLASS()
class AQUARIUSSTARTERGAME_API UItemAnimLayersAnimInstance : public UAnimInstance
{
	GENERATED_BODY()
...
public:
	...
	UFUNCTION(BlueprintPure, meta = (BlueprintThreadSafe))
		UAquaAnimInstance* GetMainAnimBPThreadSafe() const;

	UCharacterMovementComponent* GetMovementComponent() const;

	UPROPERTY(VisibleAnywhere, BlueprintReadOnly)
		UAquaAnimInstance* MainAnimBP;
	/***********************
	* ANIM SETS
	************************/
