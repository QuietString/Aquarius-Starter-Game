...
FAquaGameplayTags FAquaGameplayTags::GameplayTags;

void FAquaGameplayTags::InitializeNativeTags()
{
...
FGameplayTag FAquaGameplayTags::FindTagByString(const FString& TagString, const bool bMatchPartialString)
{
...
void FAquaGameplayTags::AddAllTags(UGameplayTagsManager& Manager)
{
...
void FAquaGameplayTags::AddTag(FGameplayTag& OutTag, const ANSICHAR* TagName, const ANSICHAR* TagComment)
{
	OutTag = UGameplayTagsManager::Get().AddNativeGameplayTag(FName(TagName), FString(TEXT("(Native) ")) + FString(TagComment));
}

void FAquaGameplayTags::AddMovementModeTag(FGameplayTag& OutTag, const ANSICHAR* TagName, uint8 MovementMode)
{
	AddTag(OutTag, TagName, "Character movement mode tag.");
	GameplayTags.MovementModeTagMap.Add(MovementMode, OutTag);
}

void FAquaGameplayTags::AddCustomMovementModeTag(FGameplayTag& OutTag, const ANSICHAR* TagName,
